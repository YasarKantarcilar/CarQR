...
const EachInfo: React.FC<Info> = ({ title, value }) => {
	return (
		<motion.a
			...
			className="w-[90%] min-w-[300px] hover:bg-black duration-500 flex-col sm:flex-col h-[90px] flex justify-center items-center bg-white-400 rounded-md bg-clip-padding backdrop-filter backdrop-blur-md bg-opacity-60 border border-gray-100"
		>
